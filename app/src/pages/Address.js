...
function Address() {
  ...
  useEffect(() => {
    ...
    //Get all transactions this address has been apart of for this specific collections
    ...
    //Call the Moralis API and fetch user collection
    ...
    <>
      ...
      {colNfts && (
        <div className="imgList">
          <div>{`User Collection: ${address}`}</div>
